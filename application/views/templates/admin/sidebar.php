        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Registeradmin">Register</a>
            ...
            <?php
            $controller = $this->uri->segment(1); // current controller
            // $method     = $this->uri->segment(2); // current method
            ?>

            <?php if ($controller === 'dashboard') : ?>
                <!-- Sidebar Message (Only on Dashboard) -->
                <div class="sidebar-card d-none d-lg-flex">
                    <img class="sidebar-caillustrationrd-illustration mb-2" src="<?= base_url('assets/admin/img/undraw_rocket.svg')?>" alt="..." style="width: 60px; height: auto;">
